        ...
        Additions.prototype.buildStacks = function () {
            ...
            if (!axis.isXAxis) {
                ...
                var _loop_1 = function () {
                    // After updating, if we now have proper stacks,
                    // we must delete the group
                    // pseudo stacks (#14986)
                    var axisSeriesStacking = axisSeries[i].yAxis.stacking;
                    if (!(axisSeries[i].options.centerInCategory &&
                        ...
                        axisSeriesStacking) {
                        objectEach(axisSeriesStacking.stacks, function (type, key) {
                ...
                // Loop up again to compute percent and stream
                // stack and delete pseudo stacks
                for (i = 0; i < len; i++) {
                    _loop_1();
                }
